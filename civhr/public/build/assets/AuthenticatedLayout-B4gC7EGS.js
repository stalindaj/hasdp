import{u as f,r as h,j as e,L as n,b as w}from"./app-CKZTajNQ.js";import{A as v}from"./ApplicationLogo-B0TkTiMG.js";const y=`
.navbar-15sw {
...
`;function k(o){return(o||"").replace(/,/g," ").split(/\s+/).filter(Boolean).slice(0,2).map(s=>s[0].toUpperCase()).join("")}function z({header:o,children:s}){const{user:t,isAdmin:a,isSuperadmin:u,canSwitchView:i,viewMode:l}=f().props.auth,d=()=>w.post(route("view-mode.toggle")),[c,g]=h.useState(!1),[x,p]=h.useState(!1),b=[{label:"Dashboard",href:route("dashboard"),on:route().current("dashboard")},!a&&{label:"My Profile",href:route("my-profile.edit"),on:route().current("my-profile.*")},{label:a?"Leave requests":"My Leave",href:route(a?"leave.requests":"leave.index"),on:route().current("leave.*")},{label:"IWOT",href:route("iwot.index"),on:route().current("iwot.*")},{label:"IPCR",href:route("ipcr.index"),on:route().current("ipcr.*")},a&&{label:"L&D",href:route("ld.index"),on:route().current("ld.index")},a&&{label:"Personnel",href:route("admin.users.index"),on:route().current("admin.users.*")||route().current("admin.employees.*")},a&&{label:"Balances",href:route("admin.balances.index"),on:route().current("admin.balances.*")}].filter(Boolean),m=l==="employee"?"← Back to admin":"View as employee";return e.jsxs("div",{className:"min-h-screen bg-gray-100",children:[e.jsx("style",{children:y}),e.jsxs("nav",{className:"navbar-15sw",children:[e.jsxs("div",{className:"bar",children:[e.jsxs(n,{href:"/",className:"brand",children:[e.jsx(v,{compact:!0}),e.jsxs("span",{className:"wm",children:[e.jsx("b",{children:"15th Strike Wing"}),e.jsx("span",{children:"Civilian Personnel Management System"})]})]}),e.jsx("div",{className:"links",children:b.map(r=>e.jsx(n,{href:r.href,className:r.on?"on":"",children:r.label},r.label))}),e.jsxs("div",{className:"right",children:[i&&e.jsx("button",{className:"hat",onClick:d,title:"Admins can preview the app exactly as an employee sees it",children:m}),e.jsxs("button",{className:"chip",onClick:()=>p(r=>!r),children:[e.jsx("span",{className:"av",children:k(t.name)}),e.jsxs("span",{style:{lineHeight:1.15},children:[t.name,e.jsx("span",{className:"role",children:l==="employee"?"employee":u?"superadmin":a?"admin":"employee"})]}),e.jsx("span",{style:{color:"#8ba3bf",fontSize:".7rem"},children:"▾"})]})]}),e.jsx("button",{className:"burger",onClick:()=>g(r=>!r),children:c?"✕":"☰"})]}),x&&e.jsxs("div",{className:"menu",onMouseLeave:()=>p(!1),children:[e.jsx(n,{href:route("profile.edit"),children:"Account settings"}),e.jsx(n,{href:route("logout"),method:"post",as:"button",children:"Log Out"})]}),c&&e.jsxs("div",{className:"drawer",children:[b.map(r=>e.jsx(n,{href:r.href,className:r.on?"on":"",children:r.label},r.label)),e.jsx("div",{className:"sep"}),e.jsx("div",{className:"who",children:t.name}),i&&e.jsx("button",{onClick:d,children:m}),e.jsx(n,{href:route("profile.edit"),children:"Account settings"}),e.jsx(n,{href:route("logout"),method:"post",as:"button",children:"Log Out"})]})]}),i&&l==="employee"&&e.jsxs("div",{className:"hatbar-15sw",children:["You are in ",e.jsx("strong",{children:"employee mode"})," — filing and viewing your own records only. ",e.jsx("button",{onClick:d,children:"Back to admin"})]}),o&&e.jsx("header",{className:"pagehead-15sw",children:e.jsx("div",{className:"inner",children:o})}),e.jsx("main",{children:s})]})}export{z as A};
